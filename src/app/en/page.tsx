      ...
      <header className="bg-white border-b">
        <div className="container mx-auto px-4 py-4">
          <nav className="flex justify-between items-center">
            <Link href="/en" className="text-2xl font-bold text-blue-600">AIverse</Link>
            <div className="flex items-center space-x-6">
              <Link href="/en/tools" className="text-gray-700 hover:text-blue-600">{t.nav.tools}</Link>
              <Link href="/en/workflows" className="text-gray-700 hover:text-blue-600">{t.nav.workflows}</Link>
              <Link href="/en/categories" className="text-gray-700 hover:text-blue-600">{t.nav.categories}</Link>
              <Link href="/zh" className="text-sm bg-gray-100 px-3 py-1 rounded hover:bg-gray-200">中文</Link>
            </div>
          </nav>
        </div>
      </header>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/en/tools" className="px-8 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition font-medium">
                {t.home.exploreTools}
              </Link>
              <Link href="/en/workflows" className="px-8 py-3 border border-blue-600 text-blue-600 rounded-lg hover:bg-blue-50 transition font-medium">
